...
def __search_IBs_process(share_dict, search_space, search_round, process_index, thread_num):
    ...
    dir0 = "Results"
    dir1 = "Results/SKINNYee_{}".format(search_round)
    ...
    for each_search in search_space:
        ...
        m = 4
        t1 = time.time()
        flag = determine_IB(8, 8 + search_round, b, e, bk, ek, 4, solve_file, thread_num)
        t2 = time.time()
